...
import 'package:myapp/Screens/HomeScreen/widgets/rectangle_indicator.dart';
import 'package:flutter/material.dart';

class MenuPager extends StatefulWidget {
  final List<b.Page> children;
...
class _MenuPagerState extends State<MenuPager> {
  ...
  Widget _renderContents(List<b.Page> pages, int selectedPageIndex,
  ...
  Widget _renderPage(b.Page page, int index, int selectedPageIndex) {
